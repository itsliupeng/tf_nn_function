...
from models.nets import inception_utils

slim = tf.contrib.slim
trunc_normal = lambda stddev: tf.truncated_normal_initializer(0.0, stddev)


def residul_inception_v3_base(inputs,
        ...
        with slim.arg_scope([slim.batch_norm, slim.dropout],
                ...
                with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
                    ...
                    with tf.variable_scope('AuxLogits'):
                        ...
                        aux_logits = slim.conv2d(
                            ...
                            normalizer_fn=None, weight_initializer=trunc_normal(0.001),
                            scope='Conv2d_2b_1x1')
                        if spatial_squeeze:
            ...
            with tf.variable_scope('Logits'):
                ...
                heat_map_features = slim.conv2d(feature_map, num_classes, [1, 1], activation_fn=None,
                                                normalizer_fn=None, scope='Conv2d_1c_1x1', reuse=True)
                if spatial_squeeze:
